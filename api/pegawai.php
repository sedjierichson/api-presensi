...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (isset($_POST['nik']) && isset($_POST['nama']) && isset($_POST['security_code']) && isset($_POST['imei'])){
        $tmp = $pegawai->insertUserBaru($_POST['nik'], $_POST['nama'], $_POST['security_code'], $_POST['imei']);
        if ($tmp == false) {
            $result['status'] = 0;
